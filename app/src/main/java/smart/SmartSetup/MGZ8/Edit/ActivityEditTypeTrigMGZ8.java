...
public class ActivityEditTypeTrigMGZ8 extends EnhancedActivity {
    Button btnExit;
    Button   btnSave;
...
public static ActivityEditTypeTrigMGZ8 activityEditTypeTrigMGZ8;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        getWindow().setBackgroundDrawable(new ColorDrawable(android.graphics.Color.TRANSPARENT));
        setContentView(R.layout.mgz8_activity_edit_type_trig);
        activityEditTypeTrigMGZ8 =this;
