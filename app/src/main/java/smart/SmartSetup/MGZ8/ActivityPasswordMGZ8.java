...
public class ActivityPasswordMGZ8 extends EnhancedActivity {
    EditText edtOldPassword;
    EditText edtNewPassword;
    EditText edtVerifyPassword;
public static ActivityPasswordMGZ8 activityPasswordMGZ8;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mgz8_activity_password);
        activityPasswordMGZ8 =this;
