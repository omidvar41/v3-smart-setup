...
import smart.SmartSetup.MG4.Edit.ActivitySendShargeMG4;
import smart.SmartSetup.MG4.Edit.Select_type_modelSim;
import smart.SmartSetup.R;

public class ActivityChargeMG4 extends EnhancedActivity {
    public  static smart.SmartSetup.MG4.ActivityChargeMG4 activityChargeMG4;
...
public static ProgressBar progressBar;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mg4_activity_charge);
        activityChargeMG4 =this;
...
btnAddCharge.setVisibility(View.VISIBLE);
        ...
        btnAddCharge.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(G.currentActivity, ActivitySendShargeMG4.class);
