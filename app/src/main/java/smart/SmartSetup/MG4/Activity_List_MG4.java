...
public class Activity_List_MG4 extends AppCompatActivity {
    public static smart.SmartSetup.MG4.Activity_List_MG4 activity_list_MG4;
    LinearLayout l1, l2, l3, l4;
    Handler handler1;
    MediaPlayer mediaPlayer;
    ActivityMain main;
    int NUMBER_ELEMENT_VIEW = 1;
    private FButton remot_name, access, zon_name, wl_name, out_name, charge, phone_number,tak, pasword, goAbout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mg4_activity_list);
        ActivityMain.go_list.setVisibility(View.VISIBLE);

        activity_list_MG4 = this;
        ...
        goAbout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(smart.SmartSetup.MG4.Activity_List_MG4.this, About_System.class));
                finish();
            }
        });
...
*/
        ...
        access.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                //setbib();
                Intent intent = new Intent(G.currentActivity, smart.SmartSetup.MG4.ActivitySmsNumberMG4.class);
        ...
        // p.setButtonColor(getResources().getColor(R.color.red));
        ...
        phone_number.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(G.currentActivity, smart.SmartSetup.MG4.ActivityPhoneNumberMG4.class);
                G.currentActivity.startActivity(intent);
                finish();
        ...
        out_name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(G.currentActivity, smart.SmartSetup.MG4.ActivityOutNameMG4.class);
                G.currentActivity.startActivity(intent);
                finish();
        ...
        charge.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(G.currentActivity, smart.SmartSetup.MG4.ActivityChargeMG4.class);
                G.currentActivity.startActivity(intent);
                finish();
        ...
        pasword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(G.currentActivity, smart.SmartSetup.MG4.ActivityPasswordMG4.class);
                G.currentActivity.startActivity(intent);
                finish();
        ...
        remot_name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(G.currentActivity, smart.SmartSetup.MG4.ActivityRemoteNameMG4.class);
                G.currentActivity.startActivity(intent);
                finish();
            }
        });
        ...
        zon_name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(G.currentActivity, smart.SmartSetup.MG4.ActivityZonNameMG4.class);
                G.currentActivity.startActivity(intent);
                finish();
            }
        });
        ...
        wl_name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(G.currentActivity, smart.SmartSetup.MG4.ActivityWlNameMG4.class);
                G.currentActivity.startActivity(intent);
                finish();
            }
        });
        ...
        tak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(G.currentActivity, smart.SmartSetup.MG4.ActivityPanelMG4.class);
                G.currentActivity.startActivity(intent);
                finish();
            }
        });
