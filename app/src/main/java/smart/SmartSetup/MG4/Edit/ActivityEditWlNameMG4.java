...
public class ActivityEditWlNameMG4 extends EnhancedActivity {
    TextView txtOutEdit;
    // TextView txtCnOutEdit;
    public static smart.SmartSetup.MG4.Edit.ActivityEditWlNameMG4 activityEditWlNameMG4;
    Button btnExitWl;
    Button   btnSaveWl;
    EditText edtWlName;
    String   Wireles,desc;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mg4_activity_edit_wl_name);
        activityEditWlNameMG4 =this;
