...
public class ActivityEditpanelSettingMG4 extends EnhancedActivity {
    public  static smart.SmartSetup.MG4.Edit.ActivityEditpanelSettingMG4 activityEditpanelSettingMG4;
    String           ss, strSend;
    Button btnExit1;
    Button           btnSave1;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mg4_activity_editpanel);
        activityEditpanelSettingMG4 =this;
        //  unicod1 = new byte[3];
