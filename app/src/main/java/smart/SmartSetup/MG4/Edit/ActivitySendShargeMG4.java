...
public class ActivitySendShargeMG4 extends EnhancedActivity {
    Button btnSendCharge;
    Button   btnExitCharge;
    EditText edtCharge;
    String   Mamory;
    public  static smart.SmartSetup.MG4.Edit.ActivitySendShargeMG4 activitySendShargeMG4;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mg4_activity_send_sharge);
        activitySendShargeMG4 =this;
