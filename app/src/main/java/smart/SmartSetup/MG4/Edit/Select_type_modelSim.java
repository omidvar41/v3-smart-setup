...
EditText editText;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mg4_dialog_select_type_model_sim);
...
openkeyboard();
            ...
            if (name.equals("IR-MCI")){
                if (ActivityChargeMG4.txtCodeChekCharge.getText().toString().equals("    ")) {
                    ...
                    editText.setText(ActivityChargeMG4.txtCodeChekCharge.getText().toString());
                    editText.requestFocus();
                    editText.setSelection(editText.length());
                    openkeyboard();
                }
...
ActivityMain.CodeChekCharge=" ";
                        ...
                        ActivityChargeMG4.progressBar.setVisibility(View.VISIBLE);
                        G.currentActivity.finish();
                    } else {
