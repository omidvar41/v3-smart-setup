...
public class About_System extends EnhancedActivity {
     TextView Iemi,bord,dialer,gosite;
public  static About_System about_system;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mg4_activity_about_system);
        about_system=this;
        Iemi=(TextView)findViewById(R.id.serialNumber);
        bord=(TextView)findViewById(R.id.mainbord);
        dialer=(TextView)findViewById(R.id.AutoDialer);
        ...
        handler1.postDelayed(new Runnable(){
            public void run(){
                ...
                handler1.postDelayed(this, 500);
                    ...
                    bord.setText(ActivityMain.bord);
                    Iemi.setText(ActivityMain.Iemi);
                    dialer.setText(ActivityMain.dialer);
